  ...
  return (
    <Section>
      ...
      <Text>
        ...
        <span>
          Our hardware and software work together seamlessly. Want to pair new
          AirPods with your iPhone? It’s a simple one‑tap setup. Want to share
          photos or contacts with friends nearby? AirDrop lists their names
          onscreen, so you can choose with a tap.
        </span>
      </Text>
    </Section>
  );
